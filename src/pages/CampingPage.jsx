...
export default function CampingPage(props) {
    ...
    const [campingCategoryDummy, setCampingCategoryDummy] = useState(categoryDummy.filter(category => category.category === "camping"));
    
    useEffect(() => {
      let sortedDummy;
      if (sortBy === "lowPrice") {
        sortedDummy = [...campingCategoryDummy].sort(
