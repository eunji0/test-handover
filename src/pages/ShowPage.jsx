...
export default function ShowPage(props) {
    ...
    const [showCategoryDummy, setShowCategoryDummy] = useState(categoryDummy.filter(category => category.category === "show"));
    
    useEffect(() => {
      let sortedDummy;
      if (sortBy === "lowPrice") {
        sortedDummy = [...showCategoryDummy].sort(
