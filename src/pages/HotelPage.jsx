...
export default function HotelPage() {
    ...
    const [hotelCategoryDummy, setHotelCategoryDummy] = useState(categoryDummy.filter(category => category.category === "hotel"));
    //임시 favorite
    ...
    useEffect(() => {
        let sortedDummy;
        if (sortBy === "lowPrice") {
            sortedDummy = [...hotelCategoryDummy].sort(
                                ...
                                <ListTicketBox key={item.seller_ID}>
                                    <BoxinTop>
                                        ...
                                        <SitBox>
                                            ...
                                            <HeartBox onClick={()=>setFavorited(!favorited)}>
                                                <img src={HeartSrc} alt="favorote"/>
